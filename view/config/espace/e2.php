...
<a href="../config.php">Retour config</a>
  ...
  <?php include "../../../crud/espace_2/select/select_content_cat.php" ?>
  <div class="corps">
    <div class="contenu">
      <div class="titre">
      ...
      <div class="perso">
        <form action="../../../crud/espace_2/update/update_cat.php" method="post">
          <div class="input-group">
            <div class="input-group-prepend">
              <span class="input-group-text">Nom et photo</span>
              <img width="20%" src="http://127.0.0.1/localhost/img/<?php echo $photo ?>" alt="">
            </div>
            <input type="text" required minlength="1" name="cat_name" value="<?php echo $name ?>"
              aria-label="First name" class="form-control">
            <input type="text" aria-label="Last name" name="photo_cat"
              value="<?php echo $photo ?>" class="form-control">
            <select class="form-control" name="tf_cat">
  ...
  <form action="../../../crud/espace_2/insert/insert_button.php" method="post">
                    <div class="input-group">
                      <div class="input-group-prepend">
        ...
        <div>
          ...
          <h5>
            Supprimer ce bouton : <a href='../../../crud/espace_2/delete/delete_button.php?del=<?php echo $donnees['id_button']; ?>'><i class="fas fa-trash-alt"></i></a>
          </h5>
        </div>
        <hr>
        </div>
