...
<a href="../config.php">Retour config</a>
  ...
  <?php include "../../../crud/espace_1/select/select_content_cat.php" ?>
  <div class="corps">
    <div class="contenu">
      <div class="titre">
      ...
      <div class="perso">
        <form action="../../../crud/espace_1/update/update_cat.php" method="post">
  ...
  <form action="../../../crud/espace_1/insert/insert_button.php" method="post">
                    <div class="input-group">
                      <div class="input-group-prepend">
        ...
        <div>
          ...
          <h5>
            Supprimer ce bouton : <a href='../../../crud/espace_1/delete/delete_button.php?del=<?php echo $donnees['id_button']; ?>'><i class="fas fa-trash-alt"></i></a>
          </h5>
        </div>
        <hr>
        </div>
